...
const CardCompte = () => {
  return (
    <Card className="rounded-[24px] h-full shadow-[var(--boxShadowCard)!important] border-0 bg-bgCard lg:p-[18px]">
      <div className="flex justify-between items-center">
        <h2 className="font-semibold text-colorTitle text-start">
          Montant dûs
        </h2>
        <Button className="bg-[#07192b] text-white text-xs h-auto py-2 shadow-none cursor-pointer  rounded-lg">
          Payer
        </Button>
      </div>
      <div className="flex flex-col gap-3 flex-grow">
        <div className="flex flex-col gap-3 bg-[#f5f7fb] p-3 rounded-xl">
          <div className="card p-3 rounded-lg bg-bgCard">
        ...
        <div className="flex items-center justify-between gap-2 mt-auto card p-3 rounded-lg bg-[#f5f7fb]">
          <p className="text-colorTitle text-sm font-medium">Total</p>
          <h6 className="text-colorTitle text-[18px] font-medium">
            600000 CDF
          </h6>
        </div>
      </div>
