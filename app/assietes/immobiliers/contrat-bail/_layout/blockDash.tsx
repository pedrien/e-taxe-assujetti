        ...
        <div className="grid grid-cols-12 items-center justify-between gap-3 mb-3 lg:mb-6">
          ...
          <div className="col-span-12 lg:col-span-6">
            ...
            <ul className="bg-bgCard p-[5px] rounded-full flex">
                ...
                <li>
                  <Link href={"/assietes/immobiliers/contrat-bail"} className="inline-flex text-sm py-[8px] px-[12px] text-white bg-[#07192b] font-medium rounded-full ">Mes contrats de bails</Link>
                </li>
              </ul>
            </div>
          </div>
