          ...
          <div className="col-span-12 lg:col-span-6">
            <div className="flex justify-center">
              <ul className="bg-bgCard p-[5px] rounded-full flex">
                <li>
                  <Link href={"/assietes/immobiliers"} className="inline-flex text-sm py-[8px] px-[12px] text-colorMuted  rounded-full hover:text-colorTitle">Mes immobiliers</Link>
                </li>
                <li>
                  <Link href={"/assietes/immobiliers/unites-locatives"} className="inline-flex text-sm py-[8px] px-[12px] text-white bg-[#07192b] font-medium rounded-full  ">Mes unités locatives</Link>
                </li>
                <li>
                  <Link href={"/assietes/immobiliers/contrat-bail"} className="inline-flex text-sm py-[8px] px-[12px] text-colorMuted hover:text-colorTitle">Mes contrats de bails</Link>
                </li>
              </ul>
            </div>
          </div>
