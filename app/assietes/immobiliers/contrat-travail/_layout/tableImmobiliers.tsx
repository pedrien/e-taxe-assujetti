...
const TableImmobiliers = () => {
  ...
  const renderCheckbox = (
    ...
    if (isHeader) {
      ...
      return (
        <Checkbox
          className="shadow-none w-[18px] h-[18px] data-[state=checked]:bg-[#494be3] data-[state=checked]:border-[#494be3]"
          checked={allSelected}
        ...
        >
          ...
          <div className="col-span-12 lg:col-span-9">
            <TabsContent value="ident">
              ...
              Déclarez les biens immobiliers que vous occupez gratuitement (sans payer de loyer). Si vous percevez une indemnité de logement à votre lieu de travail, celle-ci sert de base pour calculer l’<span className="text-colorTitle font-medium">impôt sur le revenu locatif</span>.
              </p>
                    ...
                    <tbody>
                      {identItems.map((row) => (
                        <tr key={row.id}>
                          ...
                          <td>
                            <Link href={"#"}>
                            <span className="text-colorTitle">{row.fichier}</span>
                            </Link>
                          </td>
                          <td>
